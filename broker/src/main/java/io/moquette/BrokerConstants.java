...
public final class BrokerConstants {
    ...
    public static final String HAZELCAST_TCPIP_ENABLE = "hazelcast.tcpip.enable";
    ...
    public static final String USER_INFO_CONNECTION = "user.user_info_connection";
    ...
    public static final String SPRING_RABBITMQ_HOST = "spring.rabbitmq.host";
    public static final String SPRING_RABBITMQ_PORT = "spring.rabbitmq.port";
    public static final String SPRING_RABBITMQ_USERNAME = "spring.rabbitmq.username";
    public static final String SPRING_RABBITMQ_PASSWORD = "spring.rabbitmq.password";

    public static final String ENV = "dev";

    public static final String MQ_QUEUE_USER_MESSAGE_SEND = ENV + ".queue.user.message.send";
    public static final String MQ_TOPIC_ROUTING_USER_MESSAGE_SEND = ENV + ".topic.routing.user.message.send";
    public static final String MQ_EXCHANGE_USER_MESSAGE_SEND = ENV + ".exchange.user.message.send";

    public static final String MQ_QUEUE_USER_FRIEND_SYNC = ENV + ".queue.user.friend.sync";
    public static final String MQ_TOPIC_ROUTING_USER_FRIEND_SYNC = ENV + ".topic.routing.user.friend.sync";
    public static final String MQ_EXCHANGE_USER_FRIEND_SYNC = ENV + ".exchange.user.friend.sync";

    public static final String MQ_QUEUE_GROUP_SYNC = ENV + ".queue.group.sync";
    public static final String MQ_TOPIC_ROUTING_GROUP_SYNC = ENV + ".topic.routing.group.sync";
    public static final String MQ_EXCHANGE_GROUP_SYNC = ENV + ".exchange.group.sync";

    public static final String MQ_QUEUE_GROUP_DISSOLVE = ENV + ".queue.group.dissolve";
    public static final String MQ_TOPIC_ROUTING_GROUP_DISSOLVE = ENV + ".topic.routing.group.dissolve";
    public static final String MQ_EXCHANGE_GROUP_DISSOLVE = ENV + ".exchange.group.dissolve";

    public static final String MQ_QUEUE_GROUP_MEMBER_SYNC = ENV + ".queue.group.member.sync";
    public static final String MQ_TOPIC_ROUTING_GROUP_MEMBER_SYNC = ENV + ".topic.routing.group.member.sync";
    public static final String MQ_EXCHANGE_GROUP_MEMBER_SYNC = ENV + ".exchange.group.member.sync";

    public static final String MQ_QUEUE_USER_MESSAGE_SENSITIVE = ENV + ".queue.user.message.sensitive";
    public static final String MQ_TOPIC_ROUTING_USER_MESSAGE_SENSITIVE = ENV + ".topic.routing.user.message.sensitive";
    public static final String MQ_EXCHANGE_USER_MESSAGE_SENSITIVE = ENV + ".exchange.user.message.sensitive";
    
    public static final String HTTP_FILE_PATH = "http.file.path";

    public static final String MESSAGE_LIMIT_TIME = "message.limit.time";
    public static final String MESSAGE_LIMIT_SECOND = "message.limit.second";
    public static final String MESSAGE_LIMIT_SECOND_BLOCK = "message.limit.second.block";

    public static final String IM_VERSION = "system.im.version";
