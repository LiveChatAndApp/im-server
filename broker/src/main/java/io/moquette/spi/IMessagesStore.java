...
public interface IMessagesStore {
    ...
    ErrorCodeView addGroupMembers(String operator, boolean isAdmin, String groupId, List<WFCMessage.GroupMember> memberList, String extra);
    ...
    AppUserInfo getAppUserInfo(String userId);

    void setMSGSendLimit(String userId);

    Boolean isMSGSendLimit(String userId);
}
