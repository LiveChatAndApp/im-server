...
public class ProtocolProcessorBootstrapper {
    ...
    public ProtocolProcessor init(IConfig props, List<? extends InterceptHandler> embeddedObservers,
        ...
        LOG.info("Initializing server serverIp: {}", server.getServerIp());
        LOG.info("Initializing server longPort: {}", server.getLongPort());
        LOG.info("Initializing server shortPort: {}", server.getShortPort());
