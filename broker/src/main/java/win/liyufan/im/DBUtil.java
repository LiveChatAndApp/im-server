    ...
    public static void init(IConfig config) {
        ...
        if (comboPooledDataSource == null) {
            ...
            if (IsEmbedDB) {
                ...
                String dbUrl = config.getProperty(BrokerConstants.DB_CONNECTION_URL);
                String dbUsername = config.getProperty(BrokerConstants.DB_CONNECTION_USERNAME);
                String dbPassword = config.getProperty(BrokerConstants.DB_CONNECTION_PASSWORD);
