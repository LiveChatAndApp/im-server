...
public class HttpUtils {
    ...
    public static String httpJsonPost(String url, String jsonStr) throws IOException {
        ...
        if (response.isSuccessful()) {
            ...
            if (jsonObject.getInt("code") == ErrorCode.ERROR_CODE_SUCCESS.getCode()) {
                json = jsonObject.get("result").toString();
            } else {
                LOG.error("httpJsonPost jsonObject: {}", jsonObject);
            }
        }
        return json;
    }
